    ...
    >
      <div className="z-10 h-full w-full text-sm lg:flex">
        <div className="flex h-[calc(100svh-57px)] w-full flex-col justify-between md:h-[calc(100svh-93px)]">
          ...
          <div
            className={`absolute top-12 mt-3 z-40 flex h-full w-[200px] transform flex-col bg-white p-4 transition-transform duration-200 ease-in-out dark:bg-black md:hidden ${toggle ? "translate-x-0" : "-translate-x-full"}`}
