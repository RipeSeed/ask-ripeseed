...
export default function Preview() {
  return (
    <div className='flex- flex h-full w-full flex-col space-y-3 px-2 py-4'>
      ...
      <div className='bottom flex flex-[1.5] items-center justify-between'>
        <div className='leftBtn flex cursor-pointer items-center justify-center space-x-2 rounded-lg border-2 border-solid border-gray-200 p-2 text-gray-400'>
          <Image
